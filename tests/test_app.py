...
def test_ai_program_generation_logic(client):
    ...
    client.post('/save_client', json={
        "name": "BeginnerBot", "weight": 70, "program": "Beginner (BG)", 
        "age": 20, "height": 160, "membership": ""
    })
...
def test_pdf_export_stream(client):
    ...
    client.post('/save_client', json={
        "name": "ExportUser", "weight": 75, "program": "Beginner (BG)", 
        "age": 30, "height": 170, "membership": "2024-01-01"
    })
